...
import com.luiz.bff_agendador_tarefas.business.UsuarioService;
...
public class UsuarioController {
    ...
    @PutMapping("/endereco")
    @Operation(summary = "Atualiza Endereço de Usuários", description = "Atualiza encereço de usuário")
    ...
    @Operation(summary = "Salva Endereço de Usuários", description = "Salva encereço de usuário")
